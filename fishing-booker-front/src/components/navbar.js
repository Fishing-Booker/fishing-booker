            ...
            <div className="navbar">
                <nav>
                    <ul>
                        ...
                        {userRole==="ROLE_INSTRUCTOR" && <li><Link to={`/adventureReports`}>REPORTS</Link></li>}
                        ...
                        {userRole==="ROLE_LODGEOWNER" && <li><Link to={`/lodgeReports`}>REPORTS</Link></li>}
                        ...
                        {userRole==="ROLE_SHIPOWNER" && <li><Link to={`/shipReports`}>REPORTS</Link></li>}
