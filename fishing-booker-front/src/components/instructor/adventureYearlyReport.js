...
const AdventureYearlyReport = () => {
    ...
    useEffect(() => {
        ...
        axios.get(SERVER_URL + "/users/getLoggedUser", { headers: headers })
            .then(response => {
                ...
                axios.get(SERVER_URL + "/reservationReports/forLastFiveYears/" + year + "/" + user.id, {headers: headers})
                    .then(response => {
    ...
    return (
        <div >
            <h2 >
                Number of reservation per year starting from:
...
export default AdventureYearlyReport;