                ...
                <div className="col" key={index}>
                    <div className="card res-actions-div">
                        <div className="info"> <br></br>
                            ...
                            <a className="subscribe-link" onClick={() => {}}>details</a>
                            <a className="reservation-link" onClick={() =>{}}>respond</a>
                            ...
                            <p style={{color: 'black', fontSize: '17px', marginLeft: '50px', marginTop: '20px'}}>Client username: {complaint.clientUsername}</p>
                        </div>
                    </div>
                </div>
            )
