...
import LodgeYearlyReport from './lodgeYearlyReport';
import LodgeMonthlyReport from './lodgeMonthlyReport';
import LodgeSalaryReport from './lodgeSalaryReport';
import LodgeWeeklyReport from './lodgeWeekReport';
...
const LodgeReports = () => {
    ...
    return (
        <div className="wrapper">
            ...
            <div className="info">
                    <h3>REPORTS</h3>
                    {reportType === "yearly" && <LodgeYearlyReport />}
                    {reportType === "monthly" && <LodgeMonthlyReport />}
                    {reportType === "weekly" && <LodgeWeeklyReport />}
                    {reportType === "salary" && <LodgeSalaryReport />}
                </div>
            </div>
