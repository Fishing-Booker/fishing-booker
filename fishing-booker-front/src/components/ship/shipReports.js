...
import ShipYearlyReport from './shipYearlyReport';
import ShipMonthlyReport from './shipMonthlyReport';
import ShipWeeklyReport from './shipWeeklyReport';
import ShipSalaryReport from './shipSalaryReport';
...
const ShipReports = () => {
    ...
    return (
        <div className="wrapper">
            ...
            <div className="info">
                    <h3>REPORTS</h3>
                    {reportType === "yearly" && <ShipYearlyReport />}
                    {reportType === "monthly" && <ShipMonthlyReport />}
                    {reportType === "weekly" && <ShipWeeklyReport />}
                    {reportType === "salary" && <ShipSalaryReport />}
                </div>
            </div>
