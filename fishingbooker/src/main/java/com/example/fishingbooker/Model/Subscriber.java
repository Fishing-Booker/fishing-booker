...
public class Subscriber {
    ...
    @SequenceGenerator(name = "subscriberSeqGen", sequenceName = "subscriberSeqGen", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "subscriberSeqGen")
