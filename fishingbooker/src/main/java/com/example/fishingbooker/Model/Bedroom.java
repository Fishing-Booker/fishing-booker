...
public class Bedroom {
    ...
    @SequenceGenerator(name = "bedroomSeqGen", sequenceName = "bedroomSeqGen", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "bedroomSeqGen")
